...
public class Coupon  {
  ...
  private List<EntityInfo> merchants = new ArrayList<EntityInfo>() ;
   ...
   **/
  @ApiModelProperty(value = "Merchant reference for this coupon")
  ...
  /**
   * Customer reference for this coupon
   **/
  @ApiModelProperty(value = "Customer reference for this coupon")
  ...
  public List<EntityInfo> getMerchants() {
    return merchants;
  }
  public void setMerchants(List<EntityInfo> merchants) {
