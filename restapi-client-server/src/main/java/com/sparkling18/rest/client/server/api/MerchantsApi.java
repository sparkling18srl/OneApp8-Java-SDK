...
import com.sparkling18.rest.client.server.model.ResultListMerchant;
import com.sparkling18.rest.client.server.model.Error;
import com.sparkling18.rest.client.server.model.MerchantCreate;
...
public class MerchantsApi {
  ...
  public MerchantsApi(String keyId, PrivateKey privateKey, PublicKey publicKey) {
    this.keyId = keyId;
  ...
  public MerchantsApi(String keyId, PrivateKey privateKey, PublicKey publicKey, Proxy proxy) {
    this.keyId = keyId;
    this.privateKey = privateKey;
    this.publicKey = publicKey;
    this.proxy = proxy;
   ...
   * @return ResultListMerchant
   */
  public ResultListMerchant getMerchantList (Long offset, Long pageSize, String orderOn, Boolean ascending, String externalId) throws ApiException, SecurityException {
    ...
    try {
      ...
      if(response != null){
        return (ResultListMerchant) ApiInvoker.deserialize(response, "", ResultListMerchant.class);
      }
      else {
        return null;
      }
  ...
  /**
   * create a merchant
   * Creates and returns one merchant
   * @param merchant merchant entity
   * @return Merchant
   */
  public Merchant createMerchant (MerchantCreate merchant) throws ApiException, SecurityException {
    ...
    try {
      ...
      if(response != null){
        return (Merchant) ApiInvoker.deserialize(response, "", Merchant.class);
      }
      else {
        return null;
      }
   ...
   * Returns merchant detail
   * @param id entity id
   * @return Merchant
   */
  public Merchant getMerchant (Long id) throws ApiException, SecurityException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/merchants/{id}".replaceAll("\\{format\\}","json")
   ...
   * @return void
   */
  public void deleteMerchant (Long id) throws ApiException, SecurityException {
    Object postBody = null;
   ...
   */
  public ResultListStore getMerchantStores (Long id) throws ApiException, SecurityException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/merchants/{id}/stores".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
