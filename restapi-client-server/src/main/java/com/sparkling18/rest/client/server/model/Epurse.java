...
public class Epurse  {
   ...
   **/
  @ApiModelProperty(value = "Merchant reference for this epurse")
  ...
  /**
   * Customer reference for this epurse
   **/
  @ApiModelProperty(value = "Customer reference for this epurse")
