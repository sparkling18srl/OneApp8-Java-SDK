...
import com.sparkling18.rest.client.server.model.ResultListEntityInfo;
...
public class CommonsApi {
  ...
  public CommonsApi(String keyId, PrivateKey privateKey, PublicKey publicKey) {
    this.keyId = keyId;
  ...
  public CommonsApi(String keyId, PrivateKey privateKey, PublicKey publicKey, Proxy proxy) {
    this.keyId = keyId;
    this.privateKey = privateKey;
    this.publicKey = publicKey;
    this.proxy = proxy;
  ...
  /**
   * get a list of Product Category
   ...
   * @return ResultListEntityInfo
   */
  public ResultListEntityInfo getProductCategoryList (Long offset, Long pageSize, String orderOn, Boolean ascending, String externalId) throws ApiException, SecurityException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/commons/productCategory".replaceAll("\\{format\\}","json");
    ...
    try {
      ...
      if(response != null){
        return (ResultListEntityInfo) ApiInvoker.deserialize(response, "", ResultListEntityInfo.class);
      }
      else {
        return null;
      }
