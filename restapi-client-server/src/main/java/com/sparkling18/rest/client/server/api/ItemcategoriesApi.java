...
import com.sparkling18.rest.client.server.model.ResultListItemCategory;
...
public class ItemcategoriesApi {
  ...
  private ItemcategoriesApi(){}

  public ItemcategoriesApi(String keyId, PrivateKey privateKey, PublicKey publicKey) {
    this.keyId = keyId;
  ...
  public ItemcategoriesApi(String keyId, PrivateKey privateKey, PublicKey publicKey, Proxy proxy) {
    this.keyId = keyId;
    this.privateKey = privateKey;
    this.publicKey = publicKey;
    this.proxy = proxy;
   ...
   * @return ResultListItemCategory
   */
  public ResultListItemCategory getItemList (Long offset, Long pageSize, String orderOn, Boolean ascending, String externalId) throws ApiException, SecurityException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/itemcategories".replaceAll("\\{format\\}","json");
    ...
    try {
      ...
      if(response != null){
        return (ResultListItemCategory) ApiInvoker.deserialize(response, "", ResultListItemCategory.class);
      }
      else {
        return null;
      }
   ...
   * @return ItemCategory
   */
  public ItemCategory createItemCategory (ItemCreate item) throws ApiException, SecurityException {
    ...
    try {
      ...
      if(response != null){
        return (ItemCategory) ApiInvoker.deserialize(response, "", ItemCategory.class);
      }
      else {
        return null;
      }
   ...
   * @return ItemCategory
   */
  public ItemCategory getItemCategory (Long id) throws ApiException, SecurityException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/itemcategories/{id}".replaceAll("\\{format\\}","json")
